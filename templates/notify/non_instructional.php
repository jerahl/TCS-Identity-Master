...
<ol class="steps">
  <li>Sign in to your district account at <a href="https://portal.office.com">portal.office.com</a>
      using the username and email above and the temporary password provided by your supervisor.</li>
...
<h2 class="section">District systems</h2>
<ul class="steps">
  <li>Access your <strong>district email &amp; calendar</strong> in Outlook.</li>
  <li>Log in to the <strong>employee self-service</strong> portal for pay, benefits, and leave.</li>
...
<ul class="steps">
  <li>Submit a help-desk ticket at <a href="https://help.tuscaloosacityschools.com">help.tuscaloosacityschools.com</a>
      or contact your department's technology contact.</li>
</ul>
...
current Non-Instructional orientation content. Account details are pulled live from
the Identity Master.</p>
