...
<?php endif; ?>
      ...
      <a class="nav-item<?= $nav('outputs') ?>" href="<?= e(url('/outputs')) ?>">
        <span class="nav-item__bar"></span>
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M9 16V8M5.5 11L9 7.5 12.5 11"/><path d="M2.5 5.5v-2a1 1 0 011-1h11a1 1 0 011 1v2"/></svg>
        <span>Outputs</span>
      </a>
